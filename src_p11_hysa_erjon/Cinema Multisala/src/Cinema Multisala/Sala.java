...
public class Sala {
	...
	public int[] prenotaPosti(int numPrenotazioni) {
		...
		if(numPrenotazioni <= this.numPostiTotali) //i casi gialli che rimangono sotto sono i casi in cui voglio prenotare ma non ci sono posti pero sono gia coperti dall if quindi qui entrano sempre nel caso giusto cioe quando ci sono posti quindi non puo prenotare posti che non ci sono diciamo 
		{
